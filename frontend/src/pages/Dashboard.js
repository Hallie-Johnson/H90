...
function Dashboard() {
  ...
  return (
    <div>
      <header className="page-header" style={{ backgroundImage: "url('/images/health_insurance_banner.jpg')" }}>
        <h1>Dashboard</h1>
      </header>
      <main>
        ...
        <div className="container">
          <section className="card"> 
            <a href="https://www.ers.usda.gov/media/uefd2biq/health_insurance_banner.jpg?format=jpg&quality=85">Header Image Link</a>
          </section>
        </div>
      </main>
